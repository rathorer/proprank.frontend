...
export default function Login({ callbackUrl }: Props) {
    ...
    useEffect(() => {
        let userDetails = window.sessionStorage.getItem('user-details');
        if (userDetails) {
    ...
    return (
        <section className="">
            <div className=" items-center px-5 py-12 lg:px-20">
                <div className="flex flex-col w-full max-w-md p-10 mx-auto my-6 transition duration-500 ease-in-out transform rounded-lg md:mt-0 border border-gray">
                    <div className="mt-8">
