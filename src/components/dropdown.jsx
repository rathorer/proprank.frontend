...
const Dropdown = (props) => {
    ...
    return (
        <div ref={dropdownRef} >
            ...
            {smallScreen && <div className="fixed top-0 right-[-300px] w-64 h-full bg-white transform transition-transform duration-500 ease-in-out z-40 shadow-2xl py-8 px-3" id='drawer'>
                    ...
                    <form id="search-form-drawer" className="" action="/articles/search">
                        ...
                        <div className="relative flex items-center">
                            <input
                                ...
                                name="query"
                                className="bg-gray-50 border border-gray-light text-gray-900 text-sm rounded-lg block w-full p-1.5"
                                placeholder="Search articles..."
                                required
                            />
                            <button type="submit" className="p-1 text-gray rounded-md absolute right-1">
                                <svg
                                    className="w-4 h-4"
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="mt-5 text-left text-gray-dark">
                    <a href="/#infographics" className='block px-2 py-2'>
                        <button className="">
                            Infographics
                        </button>
                    </a>
